...
export const CAR_BODIES = {
  apex:    { length: 4.68, width: 1.94, roof: 1.2,  front: 1.37, rear: -1.35, cabinFront: 0.73,  cabinRear: -1.08, roofFront: 0.16,  roofRear: -0.58, windowWidth: 0.67, radius: 0.357, spokes: 5, accent: '#1e2025', noseTaper: 0.18, flare: 0.2,  archClearance: 0.066 },
  vanta:   { length: 4.96, width: 1.96, roof: 1.31, front: 1.48, rear: -1.4,  cabinFront: 0.36,  cabinRear: -1.28, roofFront: -0.16, roofRear: -0.86, windowWidth: 0.7,  radius: 0.372, spokes: 7, accent: '#a59261', noseTaper: 0.15, flare: 0.17, archClearance: 0.062 },
  spectre: { length: 4.76, width: 2.05, roof: 1.11, front: 1.46, rear: -1.31, cabinFront: 0.75,  cabinRear: -1.09, roofFront: 0.22,  roofRear: -0.55, windowWidth: 0.6,  radius: 0.362, spokes: 5, accent: '#b9d84a', wing: true, noseTaper: 0.23, flare: 0.23, archClearance: 0.066 },
  rift:    { length: 4.24, width: 1.85, roof: 1.43, front: 1.22, rear: -1.2,  cabinFront: 0.61,  cabinRear: -1.45, roofFront: 0.2,   roofRear: -1.05, windowWidth: 0.7,  radius: 0.371, spokes: 6, accent: '#ed5034', wing: true, rally: true, noseTaper: 0.13, flare: 0.25, archClearance: 0.096 },
  vector:  { length: 4.9,  width: 2.08, roof: 1.05, front: 1.5,  rear: -1.4,  cabinFront: 0.88,  cabinRear: -1.07, roofFront: 0.22,  roofRear: -0.55, windowWidth: 0.43, radius: 0.357, spokes: 9, accent: '#f1f0e5', wing: true, prototype: true, noseTaper: 0.27, flare: 0.29, archClearance: 0.06 },
};
